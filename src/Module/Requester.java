...
public class Requester {
    ...
    public String requestpost(HashMap<String, String> datapost, String myurl) throws IOException {
        return postsend(datapost,myurl,10,15);
    }
    public String requestpost(HashMap<String, String> datapost, String myurl, int rto) throws IOException {
        return postsend(datapost,myurl,rto,15);
    }
    public String requestpost(HashMap<String, String> datapost, String myurl, int rto, int cto) throws IOException {
        return postsend(datapost,myurl,rto, cto);
    }
    public String requestget(String myurl) throws IOException {
        return getsend(myurl,10,15);
    }
    public String requestget(String myurl, int rto) throws IOException {
        return getsend(myurl,rto,15);
    }
    public String requestget(String myurl, int rto, int cto) throws IOException {
        return getsend(myurl,rto, cto);
    }
    private String getsend(String myurl, int rto, int cto) throws IOException {
        ...
        try {
            ...
            conn.setRequestProperty("appid","5ff8331b624fb");
